      ...
      <form name="CR">
        ...
        <div class="row">
          <div
            ...
            style="border: 1px solid lightgrey; padding: 10px"
          >
            <label for="ms">Maritial Status</label>
            <input
              class="form-control"
              type="text"
              id="ms"
        ...
        <div class="row">
          ...
          >
            ...
            <input type="radio" id="m" name="gender" value="" />
            <label for="male">Male</label>
            <input type="radio" id="f" name="gender" value="" />
            <label for="female">Female</label>
            <input type="radio" id="o" name="gender" value="" />
        ...
        <div class="row">
          ...
          >
            ...
            <input
              ...
              id="work"
              value=""
              placeholder="Enter work Experiance"
            />
          </div>
        </div>
